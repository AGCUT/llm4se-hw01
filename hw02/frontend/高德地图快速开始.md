...
4. 创建新应用（类型：Web�?JS API)�?
5. 添加 Key（服务平台：Web�?JS API)�?
6. 复制生成�?**Key**
...
### Q: 需要安全密钥吗�?
- 高德地图 JS API 2.0 可能需要安全密�?
- 如果看到 "Security JS Code" 错误，需要配置安全密�?
- �?`.env.local` 中添�?`VITE_AMAP_SECURITY_CODE`
