...
- `ALIYUN_REGISTRY_USERNAME`: 您的阿里�?AccessKey ID
- `ALIYUN_REGISTRY_PASSWORD`: 您的阿里�?AccessKey Secret
- `ALIYUN_NAMESPACE`: 阿里云容器镜像服务命名空间（例如：`your-username` �?`your-org`�?

**⚠️ 重要提示**�?
- 请使用您自己�?AccessKey ID �?AccessKey Secret
...
- **自动触发**：推送到 `main` �?`master` 分支，或创建版本标签
...
更多详细信息请查�?[Docker部署指南](./docs/Docker部署指南.md)
